...
final class Env
{
    private static $keys = array(
        ...
        'ELVEN_OTEL_METRICS_TEMPORALITY',
        'ELVEN_OTEL_MAX_LOG_RECORDS_PER_REQUEST',
        'ELVEN_OTEL_MAX_ATTRIBUTES_PER_SPAN',
        'ELVEN_OTEL_MAX_ATTRIBUTE_LENGTH',
        'ELVEN_OTEL_MAX_EVENTS_PER_SPAN',
        'ELVEN_OTEL_MAX_EVENT_ATTRIBUTES',
        'ELVEN_OTEL_EXPORT_TIMEOUT_MS',
        'ELVEN_OTEL_CAPTURE_CLIENT_ADDRESS',
        'ELVEN_OTEL_ID_HASH_SALT',
        'ELVEN_OTEL_DEBUG',
    );
